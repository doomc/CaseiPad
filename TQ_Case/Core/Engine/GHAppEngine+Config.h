...
#define URL_FOR_GAME            [GHAppEngine urlForApiType:API_TYPE_GAME]
#define URL_FOR_USER            [GHAppEngine urlForApiType:API_TYPE_USER]
#define URL_FOR_ADVERT          [GHAppEngine urlForApiType:API_TYPE_ADVERT]
