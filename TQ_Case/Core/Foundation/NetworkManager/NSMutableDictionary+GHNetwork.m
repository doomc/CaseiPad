//
//  NSMutableDictionary+GHNetwork.m
//  GameHelper
//
...
@implementation NSMutableDictionary (GHNetwork)
...
//设置子参数
- (void)setParameter:(void (^)(id<GHParameterDic> parameter))block forField:(NSString *)field {
    NSAssert(field, @"Field值不能为空！");
    if (field) {
        if (block) {
