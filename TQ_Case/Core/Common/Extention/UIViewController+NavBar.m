...
/***************************************************************/
#pragma mark - NavgationBar Methosds
/***************************************************************/
...
- (void)setNavTitle:(NSString *)title{
    [self setNavTitle:title textColor:RGB(51, 51, 51)];
}

- (void)setNavTitle:(NSString *)title textColor:(UIColor *)color{
    
    CGSize size = [title sizeWithFont:[UIFont systemFontOfSize:16] byHeight:44];
...
- (void)setLeftButtonWithTitle:(NSString *)title
    ...
    [button setTitleColor:RGBA(0, 132, 255,1) forState:UIControlStateNormal];
    [button setTitleColor:RGBA(0, 132, 255,0.8) forState:UIControlStateHighlighted];
...
- (void)setRightButtonWithTitle:(NSString *)title
    ...
    UIButton *button = [[UIButton alloc] initWithFrame:frame];
    [button.titleLabel setFont:font];
    [button setTitleColor:RGBA(51, 55, 64,0.8) forState:UIControlStateNormal];
    [button setTitleColor:RGBA(51, 55, 64,0.5) forState:UIControlStateHighlighted];
...
//    [button setImage:hImage forState:UIControlStateHighlighted];
    ...
    [button1 setTitle:secondTitle forState:UIControlStateHighlighted];
    [button1 addTarget:self action:secondAction forControlEvents:UIControlEventTouchUpInside];
    [button1 setTitleColor:RGBA(0, 132, 255,1) forState:UIControlStateNormal];
    [button1 setTitleColor:RGBA(0, 132, 255,0.8) forState:UIControlStateHighlighted];
    ...
    [self.navigationItem setRightBarButtonItems:[NSArray arrayWithObjects:buttonItem,buttonItem1, nil]];
}
