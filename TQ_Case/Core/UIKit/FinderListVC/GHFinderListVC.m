...
#import "GHFinderListVC.h"

@interface GHFinderListVC ()<UITableViewDataSource, UITableViewDelegate, UIDocumentInteractionControllerDelegate>
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    BOOL isDirectory = NO;
    if ([[NSFileManager defaultManager] fileExistsAtPath:fileURL.path isDirectory:&isDirectory] && isDirectory) {
        GHFinderListVC *vc = [[GHFinderListVC alloc] init];
        vc.dirURL = fileURL;
