...
#import "UIButton+GHConfig.h"
#import "UIImage+GH.h"

@implementation UIButton (GHConfig)
...
- (void)setConfigStyle:(NSString *)configStyle corner:(CGFloat)corner {
    ...
    //配置样式
    NSDictionary *styleDic = [GHAppEngine dictionaryForColorKey:configStyle];
    if (styleDic) {
...
- (void)setConfigNText:(NSString *)configNText{
    ...
    [self setTitleColor:[GHAppEngine colorForColorKey:configNText] forState:UIControlStateNormal];
}
...
- (void)setConfigHText:(NSString *)configHText{
    ...
    [self setTitleColor:[GHAppEngine colorForColorKey:configHText] forState:UIControlStateHighlighted];
}
...
- (void)setConfigSText:(NSString *)configSText{
    ...
    [self setTitleColor:[GHAppEngine colorForColorKey:configSText] forState:UIControlStateSelected];
}
...
- (void)setConfigDText:(NSString *)configDText{
    ...
    [self setTitleColor:[GHAppEngine colorForColorKey:configDText] forState:UIControlStateDisabled];
}
